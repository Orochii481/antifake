...
async function starts() {
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			const adminbotnumber = ["558892594715@s.whatsapp.net"]//seu numero
			const frendsowner = ["558892594715@s.whatsapp.net"]//seu numero
			const premium = ["558892594715@s.whatsapp.net",] 
...
case 'gay':		
				...
				case 'help':
				case 'menu':
                    client.sendMessage(from, help(prefix) , text, {quoted: mek, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": " PRIVATE OFC 😈", 'jpegThumbnail': fs.readFileSync('kk/sticker/botlogo.webp')}}}})					
                break
				case 'help1':
				case 'menu1':
